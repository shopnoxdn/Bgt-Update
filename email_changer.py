...
Provider: custom domain (MAIL_DOMAIN, e.g. bgtbot.site) whose mail is
...
"1234567@bgtbot.site" — no random suffix. Codes are read from the Gmail
...
MAIL_DOMAIN         = os.environ.get('MAIL_DOMAIN', 'bgtbot.site')
